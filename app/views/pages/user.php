...
<form action="<?php echo URLROOT ?>/Pages/addblog ?>"  method="post">
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <input name="nameart" type="text" style="height:50px;  margin:5px;  "   placeholder="Name of Blog ">
   <input  name="art"  style="height:200px;  overflow: scroll; margin:5px; "   type="textarea"  placeholder="Your Blog ">
   <input name="description"  type="text" style="height:100px; margin:5px;  overflow: scroll; "   placeholder="description">
...
<div  class="d-flex flex-column   d-flex align-items-center" >
  ...
  <div  > <a href=""data-toggle="modal" data-target="#exampleModal"> ➕</a></div>
</div>
  ...
  <a href="<?php echo URLROOT ?>/Pages/show/<?php echo $value->id   ?>" class="btn btn-primary">More</a>
</div>
    ...
    <form>
      <div class="form-row">
        <div class="form-group col-md-8">
          ...
          <input type="email" class="form-control" id="inputEmail4" placeholder="Saisissez votre nom">
        </div>
        <div class="form-group col-md-8">
          <label for="inputPassword4">E-mail</label>
          <input type="password" class="form-control" id="inputPassword4" placeholder="Saisissez votre e-mail">
        </div>
      </div>
  <div class="form-group col-md-10">
        <label for="inputAddress"> Objet</label>
        <input type="text" style="height:80px" class="form-control" id="inputAddress" placeholder="Saisissez l'objet">
      </div>
  <div class="form-group col-md-10">
        <label for="inputAddress2" >Message</label>
        <input type="text" style="height:120px"class="form-control" id="inputAddress2" placeholder="Rédigez votre message ici...">
      </div>
